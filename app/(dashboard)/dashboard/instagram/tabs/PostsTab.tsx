                    ...
                    {!confirmVariants ? (
                        ...
                        >
                            {generatingVariants
                                ...
                                : variantIds.length > 0
                                    ? "Zobrazit verze"
                                    : `Dvě verze na výběr · ${countLabel(VARIANT_COUNT * creditsForMedia(post.media_type), CREDITS)}`}
                        </button>
                    ) : (
                        <div className="w-full flex flex-col gap-2 p-3 rounded-sm bg-violet-500/5 border border-violet-500/20">
                            <p className="text-[11px] text-white/60 leading-relaxed">
                                ...
                                Každá je plnohodnotný příspěvek, takže vás vyjdou celkem na {countLabel(VARIANT_COUNT * creditsForMedia(post.media_type), CREDITS)}.
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                >
                                    Vygenerovat za {countLabel(VARIANT_COUNT * creditsForMedia(post.media_type), CREDITS)}
                                </button>
                                <button
