...
| `ig_generation_log` | `critic_score`, `critic_keep[]`, `critic_fix[]`, `strategy`, `editorial_rounds`, `final_score`, `consistency_score` | Critic → learning + pipeline v2 atribuce/drift senzor |
