...
| `ELEVENLABS_API_KEY` | ElevenLabs TTS — hlas značky v reelech (`eleven_v3`, fallback `eleven_multilingual_v2` se stejným hlasem). Skutečný klíč začíná `sk_`; bez něj poskytovatel `elevenlabs` hází a reel se parkuje |
